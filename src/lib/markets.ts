  ...
  },
  {
    ...
    spots: [
      ...
      },
      {
        name: "十三行 (시산행)",
        nameKr: "십삼행 의류시장",
        desc: "중저가 여성의류 도매 특화. 좁은 골목에 수백 개 도매상 밀집. 오전 6시~6시30분부터 가장 활발, 낮 12시에 마감.",
        tip: "오전 일찍 방문 추천. 현금 선호, 위챗페이 병행"
      },
      {
        name: "白马服装城",
        nameKr: "바이마 의류시장",
        desc: "광저우역(广州站) 인근 중고급 의류 도매시장. 홍콩 스타일 트렌드 의류 강세. 십삼행과는 다른 구역(越秀区).",
      },
      {
        name: "沙河服装城",
        nameKr: "사허 의류시장",
        desc: "캐주얼·스트리트 패션 도매. 젊은 층 대상 패션 소싱에 유리.",
        tip: "지하철 6호선 沙河顶역 도보 5분"
      },
      {
        name: "华南城 (深圳平湖)",
        nameKr: "화남청 (선전 핑후)",
  ...
  },
  {
    ...
    spots: [
      ...
      },
      {
        ...
        tip: "아사쿠사 인근. 일요일·공휴일 휴무 많음 (평일 방문 권장)"
      },
    ],
  },
  {
