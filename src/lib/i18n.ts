...
const dict: Record<string, Record<LangId, string>> = {
  ...
  "home.researching":  { ko:"시장조사중", en:"Researching", ja:"調査中", zh:"调研中", "zh-tw":"調研中", ru:"Исследование", th:"กำลังวิจัย" },
  "home.in_progress":  { ko:"발주진행중", en:"In Progress", ja:"発注進行中", zh:"采购中", "zh-tw":"採購中", ru:"В процессе", th:"กำลังดำเนินการ" },
  "home.arrived":      { ko:"입고완료", en:"Arrived", ja:"入庫完了", zh:"已入库", "zh-tw":"已入庫", ru:"Получено", th:"รับสินค้าแล้ว" },
